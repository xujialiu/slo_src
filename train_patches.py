...
from util.datasets_patches import build_dataset, get_weighted_sampler
...
def main(args):
    ...
    if args.model == "vit_large_patch16_patches":
        model = vit_model_patches.vit_large_patch16_patches(
    ...
    elif args.model == "vit_base_patch16_patches":
        model = vit_model_patches.vit_base_patch16_patches(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
            fusion_layer_num=args.fusion_layer_num,
        ...
        model = vit_model_patches.vit_large_patch16(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
        )
    elif args.model == "vit_base_patch16":
        model = vit_model_patches.vit_base_patch16(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
        )
    elif args.model == "vit_large_patch16_multiscales":
        model = vit_model_patches.vit_large_patch16_multiscales(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
            fusion_layer_num=args.fusion_layer_num,
    ...
    elif args.model == "vit_base_patch16_multiscales":
        model = vit_model_patches.vit_base_patch16_multiscales(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
            fusion_layer_num=args.fusion_layer_num,
    ...
    elif args.model == "vit_base_patch16_multiscales_without_ppe":
        model = vit_model_patches.vit_base_patch16_multiscales_without_ppe(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
            fusion_layer_num=args.fusion_layer_num,
    ...
    elif args.model == "vit_base_patch16_multiscales_with_mean":
        model = vit_model_patches.vit_base_patch16_multiscales_with_mean(
            input_size=args.input_size,
            num_classes=args.nb_classes,
            drop_path_rate=args.drop_path,
            fusion_layer_num=args.fusion_layer_num,
    ...
    if args.lora_position == "all":
        ...
        target_modules = "blocks\.\d+\.attn\.qkv$"
    ...
    for name, param in model.named_parameters():
        if (
            ...
            or "lora" in name
            or "fc_norm" in name
            or "patch_blocks" in name
            or "patch_pos_embed" in name
            or "fusion_pos_embed" in name
        ):
